...
$dataParameter = $this->session->userdata('data_limite_analise_coordenador');
...
if( $dateActual > $dataParameter)
{
    ...
    echo "<div class='panel-heading'>";
      echo "<h3 class='panel-title'>Informativo</h3>";
    echo "</div>";

    echo "<div class='panel-body'>";
      echo "<center><br><span class='label label-danger'>Data limite para análise das provas enviadas pelos professores expirou dia ".$formateDateBr."!</span></center><br>";
    echo "</div>";
  echo "</div>";
}
else
{
            ...
            echo "<div class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-bullhorn' aria-hidden='true'></span> Caro coordenador, o sistema estará aberto para sua análise até dia ".$formateDateBr.".</div>";
            echo "<div class='panel panel-default'>";
            echo "<div class='panel-heading'>";
                echo "<h3 class='panel-title'>Provas <b>enviadas</b> para o coordenador</h3>";
            echo "</div>";
                    ...
                    if( $provas )
                    {
                        ...
                        <?php
                            ...
                            echo "<td>";                
                            if( $prova->id_status == 1){
                                echo "<span class='label label-default'>Enviado</span>";    
                            }
                            if( $prova->id_status == 2){
                                echo "<span class='label label-success'>Aceito</span>";    
                            }
                            ...
                            if($prova->motivo)
                            {
                                ...
                                echo "<td><a href='#' data-toggle='modal' data-target='#basicModalV" .$prova->id."'><img src='".base_url()."assets/imgs/user_comment.png'></a></td>";
                            ...
                            if( count($prova->totalarquivos) > 0  and $prova->path )
                            {
                                ...
                                {
                                  echo "<a href='../".$array[$zz]."' target='_blank'><img src='".base_url()."/assets/imgs/table_edit.png'></a> ";                   
                                }
                                echo "</td>";
                            }else{
                                echo "<td> - </td>";
             ...
             echo "<center><br><span class='label label-danger'> Nenhuma prova enviada para esta coordenação até o momento!</span><br><br>";
        }    
...
<!-- INICIO DAS  LISTA DE PROVAS ENVIADAS PARA O COORDENADOR-->

<?php
            echo "<div class='panel panel-default'>";
            echo "<div class='panel-heading'>";
                echo "<h3 class='panel-title'>Provas <b>analisadas</b> pelo coordenador</h3>";
            echo "</div>";
...
<!-- FIM DA LISTA DE PROVAS ENVIADAS PARA O COORDENADOR-->
