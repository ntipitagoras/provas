...
else
{
      ...
      echo "<div class='alert alert-danger' role='alert'><span class='glyphicon glyphicon-bullhorn' aria-hidden='true'></span> Caro professor, o sistema estará aberto para envio do grupo 1 até dia <b>".date('d/m/Y',strtotime($this->session->userdata('data_limite_grupo_1')))."</b> e grupo 2 até dia <b>".date('d/m/Y',strtotime($this->session->userdata('data_limite_grupo_2')))."</b> </div>";

        echo "Grupo 1: Pedagogia, Contábeis, Administração, Serviço Social; Secretariado; CSTs, Enfermagem, Educação Física, Letras, Nutrição, Odontologia, Fisioterapia.";
        echo "<br>";
        echo "Grupo 2: Engenharias, Computação, Farmácia, Psicologia, Direito, Arquitetura e Biomedicina.";
        echo "<br><br>";
